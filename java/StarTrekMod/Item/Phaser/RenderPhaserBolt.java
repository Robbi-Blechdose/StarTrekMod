...
public class RenderPhaserBolt extends Render
{
	...
	protected ResourceLocation getArrowTextures(EntityPhaserBolt par1EntityArrow)
	{
		return boltTextures;
	}
	...
	{
		return this.getArrowTextures((EntityPhaserBolt) par1Entity);
	}
